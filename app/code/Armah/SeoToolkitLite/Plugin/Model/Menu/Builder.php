...
namespace Armah\SeoToolkitLite\Plugin\Model\Menu;
...
{
    protected $seoLinks = [
        'Armah_Meta::seoToolkitLite',
        'Armah_XmlSitemap::xml_sitemap'
    ];
            ...
            if ($item) {
                ...
                */
                foreach ($itemsToMove as $id => $sort) {
                    $menu->move($id, 'Armah_SeoToolkitLite::seotoolkitlite', $sort * 100);
                }

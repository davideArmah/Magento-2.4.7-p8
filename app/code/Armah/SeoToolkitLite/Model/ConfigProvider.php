...
class ConfigProvider extends ConfigProviderAbstract
{
     ...
     * @var string '{section}/'
     */
    protected $pathPrefix = 'arseotoolkit/';
    ...
    private const TOOLBAR_ENABLE = 'toolbar/enable';
    private const TOOLBAR_IP = 'toolbar/ip';
    ...
    public function isToolbarEnabled(?int $storeId = null): bool
    {
        return (bool)$this->getValue(self::TOOLBAR_ENABLE, $storeId);
    }

    public function getToolbarIps(?int $storeId = null): array
    {
        $ips = (string)$this->getValue(self::TOOLBAR_IP, $storeId);

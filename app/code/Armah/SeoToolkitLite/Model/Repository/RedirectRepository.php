...
class RedirectRepository implements RedirectRepositoryInterface
{
    ...
    public function getById($id)
    {
        if (!isset($this->redirects[$id])) {
            /** @var \Armah\SeoToolkitLite\Model\Redirect $redirect */
    ...
    public function getList(SearchCriteriaInterface $searchCriteria)
    {
        ...
        /** @var \Armah\SeoToolkitLite\Model\ResourceModel\Redirect\Collection $redirectCollection */

...
namespace Armah\SeoToolkitLite\Block;
...
class Toolbar extends Template
{
    ...
    public function __construct(
        ...
        $this->setTemplate('Armah_SeoToolkitLite::toolbar.phtml');
            ...
            if (isset($result[0]) && isset($result[1])) {
                ...
                $external = array_filter($result[1], function ($url) {
                    try {
                        ...
                        $host = $uri->getHost();
                    } catch (\Laminas\Uri\Exception\InvalidArgumentException $exc) {
                        $host = null;
                    }
    ...
    {
        return $this->registry->registry('armeta_applied_rule');
    }

define([
    ...
    $.widget('mage.arSeoToolbar', {
        contentSelector: '[data-js="arskit-content"]',
        closeSelector: '[data-js="arskit-close"]',
        showMoreSelector: '[data-js="arskit-showmore"]',
        showButtonSelector: '[data-js="arskit-showbutton"]',
        maxVisibleImgs: 2,
        ...
        showMore: function () {
            ...
            if (urls.length > self.maxVisibleImgs) {
                ...
                buttonTemplate = '<div class="arskit-separator-wrap" data-js="arskit-showbutton">' +
                    '<div class="arskit-button">' + $tr('other ') + count + '</div></div>';

    ...
    return function() {
        ...
        this.initSearch = function () {
            ...
            $('.htmlsitemap-search-input').each(function () {
                ...
                $('.ar-sitemap-wrap a').each(function (key, el) {
        ...
        this.contentSearch = function (text) {
            ...
            $('.ar-always-visible').each(function (key, el) {
                $(el).removeClass('ar-always-visible');
            });
            ...
            $('.ar-sitemap-wrap a').each(function(key, el) {
                ...
                if (instance.currentTextValue.replace(/\s+/, '') != '') {
                    if (el.defaultTextContent.toLowerCase().indexOf(instance.currentTextValue) == -1) {
                        if (!$(el).parent().hasClass('ar-always-visible')) {
                            $(el).parent().hide();
                        }
                    } else {
                        $(el).parent().show();
                        ...
                        while (leaf.length) {
                            leaf.show();
                            leaf.addClass('ar-always-visible');
        ...
        this.showAllLeafs = function (el) {
            ...
            leafs.each(function() {
                $(this).show();
                $(this).addClass('ar-always-visible');

...
namespace Armah\SeoHtmlSitemap\Block;

use Magento\Framework\App\ObjectManager;
use Magento\Framework\View\Element\Template;
use Magento\Framework\View\Element\Template\Context;
use Armah\SeoHtmlSitemap\Helper\Data as SitemapHelper;
use Armah\SeoHtmlSitemap\Helper\Renderer as RendererHelper;
use Armah\SeoHtmlSitemap\Model\ConfigProvider;
use Armah\SeoHtmlSitemap\Model\SitemapFactory;
...
class Sitemap extends Template
{
    ...
    {
        /** @var \Armah\SeoHtmlSitemap\Model\Sitemap $sitemapDataModel */
    ...
    {
        if (!$this->helper->isModuleOutputEnabled('Armah_Xlanding') || !$this->helper->canShowLandingPages()
    ...
    {
        return $this->configProvider->getSortOrder();
    }

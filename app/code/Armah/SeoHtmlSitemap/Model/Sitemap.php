...
use Armah\SeoHtmlSitemap\Model\ResourceModel\Page\Xlanding\CollectionFactory as LandingPageCollectionFactory;
use Magento\CatalogInventory\Helper\Stock;
use Magento\Cms\Helper\Page as CmsPageHelper;
use Armah\SeoHtmlSitemap\Helper\LandingPage as LandingPageHelper;
use Armah\SeoHtmlSitemap\Helper\Data as SeoSitemapHelper;
...
class Sitemap extends AbstractModel
{
    ...
    {
        if (!$this->helper->isModuleOutputEnabled('Armah_Xlanding')) {
            return [];
        }
    ...
    protected function _getCategoryCollection()
    {
        ...
        if (!empty($excludeCategoryIds = $this->getExcludeCategoryIds())) {
            $collection->addFieldToFilter($entityField, ['nin' => $excludeCategoryIds]);
        }

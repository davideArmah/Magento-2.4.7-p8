...
namespace Armah\CheckoutLayoutBuilder\Block\Config;

use Armah\Base\Model\Serializer;
use Armah\CheckoutLayoutBuilder\Model\Config\CheckoutBlocksProvider;
...
class LayoutBuilderArea extends Field
{
    ...
    {
        $this->_template = 'Armah_CheckoutLayoutBuilder::system/config/form/field/layout_builder_area.phtml';

...
define([], function () {
    ...
    const LAYOUT_CONFIG_FIELDS_ID = {
            design: 'armah_checkout_design_layout_checkout_design',
            modernLayout: 'armah_checkout_design_layout_layout_modern',
            classicLayout: 'armah_checkout_design_layout_layout'
        },
        USE_DEFAULT_CHECKBOXES_ID = {
            design: 'armah_checkout_design_layout_checkout_design_inherit',
            modernLayout: 'armah_checkout_design_layout_layout_modern_inherit',
            classicLayout: 'armah_checkout_design_layout_layout_inherit',
            builder: 'armah_checkout_design_layout_frontend_layout_config_inherit'
        },
    ...
    return {
        ...
        /**
         * Init use default checkboxes state

...
class Advertising extends Template
{
     ...
     * @var string
     */
    protected $_template = 'Armah_CronScheduleList::advertising.phtml';
    ...
    {
        if ($this->moduleManager->isEnabled('Armah_CronScheduler') || $this->moduleHelper->isOriginMarketplace()) {
            return '';
        }
    ...
    {
        return 'https://armah.it/cron-scheduler-for-magento-2.html'

...
class Extensions
{
    public const EXTENSIONS_CACHE_ID = 'arbase_extensions';
    public const ARMAH_EXTENSIONS_LAST_MODIFIED_DATE = 'armah_extensions_last_modified_date';
    ...
    {
        return $this->cache->load(self::ARMAH_EXTENSIONS_LAST_MODIFIED_DATE);
    }
    ...
    private function setLastModified()
    {
        ...
        return $this->cache->save($dateTime, self::ARMAH_EXTENSIONS_LAST_MODIFIED_DATE);
    }

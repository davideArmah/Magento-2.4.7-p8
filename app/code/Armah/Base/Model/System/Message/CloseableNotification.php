...
namespace Armah\Base\Model\System\Message;

use Armah\Base\Model\FlagRepository;
use Armah\Base\Model\System\Message\DisplayValidator\DisplayValidatorInterface;
...
class CloseableNotification implements MessageInterface
{
    ...
    private const IGNORE_NOTIFICATION_PATH = 'arbase/notification/ignoreNotification';

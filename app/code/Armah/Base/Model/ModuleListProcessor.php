...
class ModuleListProcessor
{
    ...
    public function getModuleList()
    {
        ...
        foreach ($modules as $moduleName) {
            if ($moduleName === 'Armah_Base'
                || strpos($moduleName, 'Armah_') === false
    ...
    private function getModuleInfo(string $moduleCode): array
    {
        ...
        $module['description'] = $this->replaceArmahText($module['description']);
        ...
        if ($allExtensions && isset($allExtensions[$moduleCode])) {
            ...
            $module['description'] = $this->replaceArmahText($ext['name']);
     ...
     * @return string
     */
    private function replaceArmahText($moduleName)
    {
        return str_replace(['for Magento 2', 'by Armah'], '', $moduleName);
    }
}

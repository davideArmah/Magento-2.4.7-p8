...
namespace Armah\Base\Block\Adminhtml\System\Config\Form\Field\Promo;
...
class PromoGrid extends Template
{
    ...
    public const DEFAULT_PROMO_ICONS = [
        'subscribe' => 'Armah_Base::images/components/promotion-grid/lock.svg',
        'upgrade' => 'Armah_Base::images/components/promotion-grid/lock-upgrade.svg'
    ];

    /**
     * @var string
     */
    protected $_template = 'Armah_Base::config/promo-grid.phtml';

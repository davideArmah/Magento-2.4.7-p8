...
class VersionInfo extends Template
{
     ...
     * @var string
     */
    protected $_template = 'Armah_Base::config/information/version_info.phtml';
    ...
    public function getLogoHref(): string
    {
        ...
        if ($this->moduleInfoProvider->isOriginMarketplace()) {
            ...
            $href = '' . Information::SEO_PARAMS . 'armah_logo_' . $moduleCode;
        }
    ...
    {
        return $this->assetRepo->getUrl('Armah_Base::images/armah_logo.svg');
    }

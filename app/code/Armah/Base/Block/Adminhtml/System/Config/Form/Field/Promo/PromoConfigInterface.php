...
interface PromoConfigInterface
{
    ...
    public const PROMO_CONFIGS = [
        self::PLAN_SUBSCRIBE => [
            ...
            self::ICON_SRC_KEY => 'Armah_Base::images/components/promotion-field/lock.svg',
        ...
        self::PLAN_UPGRADE => [
            ...
            self::ICON_SRC_KEY => 'Armah_Base::images/components/promotion-field/lock-upgrade.svg',

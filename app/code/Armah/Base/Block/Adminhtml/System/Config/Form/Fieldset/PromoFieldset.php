...
namespace Armah\Base\Block\Adminhtml\System\Config\Form\Fieldset;

use Armah\Base\Utils\XssStringEscaper;
...
class PromoFieldset extends Fieldset
{
    ...
    public const PLAN_TYPES = [
        'subscribe' => [
            'iconSrc' => 'Armah_Base::images/components/promotion-fieldset/subscribe.svg',
            'iconBgColor' => '#ebe7ff',
            'text' => 'Subscribe to Unlock',
        ],
        'upgrade' => [
            'iconSrc' => 'Armah_Base::images/components/promotion-fieldset/upgrade.svg',
    ...
    {
        return <<<TEXT
                <div class="message message-info arpromo-config-info">
    ...
    {
        return <<<ICON
            <span class="arpromo-config-icon fieldset-icon"
                style="
    ...
    {
        return <<<TEXT
            <span class="arpromo-config-fieldset-notification-message">

...
use Armah\Base\Block\Adminhtml\System\Config\InformationBlocks\Basic;
...
class Information extends Fieldset
{
    ...
    private function getInnerHtml(string $moduleCode, AbstractElement $element): string
    {
        ...
        $basicBlock = $layout->getBlock('arinfotab.basic');
        if ($basicBlock) {

...
namespace Armah\Base\Setup\Declaration\Schema\Db\MySQL\DDL\Triggers;
 ...
 * onCreate="arMigrateDataSetFromTableColumn(from_table_name, from_column, target_column)"
...
{
    public const MATCH_PATTERN = '/arMigrateDataSetFromTableColumn\(([^\)]+),([^\)]+),([^\)]+)\)/';

define([
    ...
    $.widget('arbase.messageToggler', {
        ...
        textContainerSelector: '[data-arbase-message-additional]',
        toggleBtnSelector: '[data-arbase-message-toggle-btn]',
        isOpen: false,

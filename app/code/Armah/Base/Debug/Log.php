...
use Armah\Base\Debug\System\ArmahFormatter;
use Armah\Base\Debug\System\LogBeautifier;
...
/**
 * For Remote Debug
 * Output is going to file armah_debug.log
 * @codeCoverageIgnore
...
class Log
{
     ...
     * @var string
     */
    private static $fileToLog = 'armah_debug.log';
...
%message%
----------------------------------------------------------------------------\n\n";
        $formatter = new ArmahFormatter($output);

        $handler->setFormatter($formatter);
        self::$loggerInstance = new Logger('armah_logger', [$handler]);
    }
}

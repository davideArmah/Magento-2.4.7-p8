...
namespace Armah\Base\Plugin\Indexer\Model\Indexer;
...
class SkipException
{
    ...
    {
        if ($this->isArmahIndexer($subject)
    ...
    private function isArmahIndexer(Indexer $subject): bool
    {
        return stripos($subject->getActionClass(), 'Armah') === 0;
    }
}

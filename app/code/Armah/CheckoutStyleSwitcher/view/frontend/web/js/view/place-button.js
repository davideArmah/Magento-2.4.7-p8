define(
    [
        ...
        'Armah_CheckoutCore/js/model/payment/payment-loading',
        'Armah_CheckoutStyleSwitcher/js/action/start-place-order',
        'Armah_CheckoutStyleSwitcher/js/model/aralert',
        'Armah_CheckoutCore/js/action/focus-first-error',
        'Armah_CheckoutCore/js/model/payment-validators/login-form-validator',
        'Armah_CheckoutCore/js/model/address-form-state',
        'Armah_CheckoutCore/js/model/one-step-layout',
    ...
    function (
        ...
        return Component.extend({
            defaults: {
                template: 'Armah_CheckoutStyleSwitcher/onepage/place-order',
            ...
            toggleOriginalToolbar: function (state) {
                var classNames = oneStepLayout.containerClassNames().replace(' ar-submit-summary', '');

                if (state) {
                    classNames += ' ar-submit-summary';
                }

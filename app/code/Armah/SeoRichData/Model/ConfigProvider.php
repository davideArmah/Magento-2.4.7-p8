...
class ConfigProvider extends ConfigProviderAbstract
{
    ...
    public const COUNTRY_ORGANIZATION_PATH = 'organization/country';

    /**
     * @var string
     */
    protected $pathPrefix = 'arseorichdata/';
    ...
    {
        return (string) $this->getValue(self::COUNTRY_ORGANIZATION_PATH);
    }
}

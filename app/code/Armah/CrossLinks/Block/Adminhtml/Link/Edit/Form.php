...
namespace Armah\CrossLinks\Block\Adminhtml\Link\Edit;

/**
 * Class Form
 * @package Armah\CrossLinks\Block\Adminhtml\Link\Edit
 */
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    /**
     * @var \Armah\CrossLinks\Model\Source\ReferenceType
     */
    protected $sourceReferenceType;

    /**
     * @var \Armah\CrossLinks\Model\Source\TargetType
     */
     ...
     * @param \Armah\CrossLinks\Model\Source\ReferenceType $referenceType
     * @param \Armah\CrossLinks\Model\Source\TargetType $targetType
     * @param array $data
     */
    public function __construct(
        ...
        \Armah\CrossLinks\Model\Source\ReferenceType $referenceType,
        \Armah\CrossLinks\Model\Source\TargetType $targetType,
        array $data = []
    ) {
    ...
    protected function _prepareForm()
    {
        ...
        $referenceResource->setRenderer(
            $this->getLayout()
                ->createBlock(\Armah\CrossLinks\Block\Adminhtml\Link\Edit\Form\Renderer\ReferenceResource::class)
        );

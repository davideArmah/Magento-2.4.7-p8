...
namespace Armah\CrossLinks\Model\ResourceModel;

use Magento\Framework\Model\ResourceModel\Db\AbstractDb;

/**
 * Class Link
 * @package Armah\CrossLinks\Model\ResourceModel
 */
class Link extends AbstractDb
{
    ...
    {
        $this->_init('armah_cross_link', 'link_id');
    }
    ...
    protected function _afterSave(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        if ($storeIds && ($storeIds != $object->getOrigData('store_ids'))) {
            ...
            $this->getConnection()->delete($this->getTable('armah_cross_link_store'),
            ...
            $this->getConnection()->insertOnDuplicate($this->getTable('armah_cross_link_store'), $dataForInsert, []);
        }
    ...
    protected function _afterLoad(\Magento\Framework\Model\AbstractModel $object)
    {
        if ($object->getId()) {
            $select = $this->getConnection()->select()
                ->from($this->getTable('armah_cross_link_store'), 'store_id')

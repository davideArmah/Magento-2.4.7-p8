...
namespace Armah\Meta\Observer\Catalog\Category;

use Armah\Meta\Helper\Data;
use Armah\Meta\Model\Meta\ReplacedData;
use Armah\Meta\Model\Registry;
use Armah\Meta\Plugin\ShopbyBrand\Controller\RouterPlugin;
...
class InitAfter implements ObserverInterface
{
    ...
    public function __construct(
        ...
        \Armah\Meta\Helper\Data $metaHelper,
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        $forceOverwrite = $this->_scopeConfig->isSetFlag('armeta/cat/force');
        $replacedData = [];
        ...
        foreach ($replace as $key) {
            ...
            $max = (int) $this->_scopeConfig->getValue(
                'armeta/general/max_'.$key,
                \Magento\Store\Model\ScopeInterface::SCOPE_STORE
            );

            if ($max) {
                $tag = mb_substr($tag, 0, $max, \Armah\Meta\Helper\Data::DEFAULT_CHARSET);
            }

...
namespace Armah\Meta\Model\Repository;

use Armah\Meta\Api\Data\ConfigInterface;
use Armah\Meta\Api\ConfigRepositoryInterface;
use Armah\Meta\Model\ConfigFactory;
use Armah\Meta\Model\ResourceModel\Config as ConfigResource;
use Armah\Meta\Model\ResourceModel\Config\CollectionFactory;
use Armah\Meta\Model\ResourceModel\Config\Collection;
...
class ConfigRepository implements ConfigRepositoryInterface
{
    ...
    public function getById($id)
    {
        if (!isset($this->configs[$id])) {
            /** @var \Armah\Meta\Model\Config $config */
    ...
    public function getList(SearchCriteriaInterface $searchCriteria)
    {
        ...
        /** @var \Armah\Meta\Model\ResourceModel\Config\Collection $configCollection */

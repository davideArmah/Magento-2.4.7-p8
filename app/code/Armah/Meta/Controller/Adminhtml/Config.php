...
use Armah\Meta\Api\Data\ConfigInterfaceFactory;
...
abstract class Config extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $this->_setActiveMenu('Armah_Meta::config')->_addBreadcrumb(
    ...
    {
        return $this->_authorization->isAllowed('Armah_Meta::config');
    }
}

...
namespace Armah\Meta\Block\Adminhtml\Config;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    public function __construct(
        ...
        \Armah\Meta\Helper\Data $helper,
        \Armah\Meta\Model\Config $config,
        array $data = []
    ) {
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('category_id', [
            'header' => __('Category'),
            'index' => 'category_id',
            'renderer' => \Armah\Meta\Block\Adminhtml\Widget\Grid\Column\Renderer\Category::class,
        ...
        if (!$this->_storeManager->isSingleStoreMode()) {
            $this->addColumn('store_id', [
                ...
                'type' => 'store',
                'renderer' => \Armah\Meta\Block\Adminhtml\Widget\Grid\Column\Renderer\Store::class,
                'filter' => \Armah\Meta\Block\Adminhtml\Widget\Grid\Column\Filter\Store::class,
                'store_view' => true,
                'sortable' => false
            ]);
        }

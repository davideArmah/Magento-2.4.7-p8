...
define([
    ...
    'Armah_CheckoutDeliveryDate/js/model/datepicker-keydown-events',
    'mage/translate'
    ...
    return AbstractField.extend({
        ...
        initConfig: function () {
            ...
            this.options.firstDay = this.archeckout_firstDay;

            if (this.archeckout_days.length > 0) {
        ...
        restrictDates: function (d) {
            return [$.inArray(d.getDay(), this.archeckout_days) != -1, ''];
        }
    });
});

...
namespace Armah\CheckoutDeliveryDate\Block\Adminhtml\Sales\Order\Create;
...
class Deliverydate extends Template
{
    ...
    protected function _construct()
    {
        ...
        $this->setTemplate('Armah_CheckoutDeliveryDate::sales/order/delivery_create.phtml');
    }

    public function getFormElements()
    {
        $form = $this->formFactory->create();
        $form->setHtmlIdPrefix('armah_checkout_deliverydate_');

...
{
    public const ENTITY_TYPE_CODE = 'armah_checkout';
    public const GRID_INDEXER_ID = 'armah_order_attribute_grid';
    public const INITIAL_AUTOINCREMENT_VALUE = 0;
    public const TABLE_NAME = 'armah_order_attribute_entity';
    public const ENTITY_INCREMENT_TABLE = 'armah_order_attribute_entity_increment';
    ...
    {
        if ($attribute instanceof \Armah\Orderattr\Model\Attribute\Attribute) {
     ...
     * (@see \Armah\Orderattr\Model\Entity\Handler\Save) because DDL statements are not allowed in transactions.
     *
     * @return int
     */

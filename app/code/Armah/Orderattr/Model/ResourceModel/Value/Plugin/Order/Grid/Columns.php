...
namespace Armah\Orderattr\Model\ResourceModel\Value\Plugin\Order\Grid;
...
class Columns
{
    ...
    /**
     * @var \Armah\Orderattr\Model\Attribute\InputType\GridUiCaster
     */
    ...
    public function __construct(
        ...
        \Armah\Orderattr\Model\ConfigProvider $config,
        \Armah\Orderattr\Model\Attribute\InputType\GridUiCaster $gridUiCaster,
    ...
    private function addInlineEdit($columnsComponent)
    {
        ...
        /** @see app/code/Armah/Orderattr/view/adminhtml/ui_component/sales_order_grid.xml */
    ...
    /**
     * @return \Armah\Orderattr\Model\Attribute\Attribute[]
     */
    protected function getAttributesList()
    {
        /** @var \Armah\Orderattr\Model\ResourceModel\Attribute\Collection $collection */

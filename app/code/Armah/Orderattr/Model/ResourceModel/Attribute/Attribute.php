...
use Armah\Orderattr\Model\Attribute\Attribute as EntityAttribute;
use Magento\Framework\Model\ResourceModel\Db\Context;
use Magento\Store\Model\StoreManagerInterface;

class Attribute extends \Magento\Eav\Model\ResourceModel\Entity\Attribute
{
    public const TABLE_NAME = 'armah_order_attribute_eav_attribute';
    public const STORE_TABLE_NAME = 'armah_order_attribute_eav_attribute_store';
    public const CUSTOMER_GROUP_TABLE_NAME = 'armah_order_attribute_eav_attribute_customer_group';
    public const TOOLTIP_TABLE_NAME = 'armah_order_attribute_tooltip';
    public const SHIPPING_METHODS_TABLE_NAME = 'armah_order_attribute_shipping_methods';

...
namespace Armah\Orderattr\Model\Order\Pdf\Traits;
...
trait AbstractPdfTrait
{
     ...
     *
     * @return \Armah\Orderattr\Model\Value\Metadata\Form
     */
    protected function createEntityForm($entity, $store)
    {
        /** @var \Armah\Orderattr\Model\Value\Metadata\Form $formProcessor */

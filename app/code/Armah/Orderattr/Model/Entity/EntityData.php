 ...
 * @method \Armah\Orderattr\Model\ResourceModel\Entity\Entity _getResource()
 * @method \Armah\Orderattr\Model\ResourceModel\Entity\EntityData\Collection getCollection()
 */
class EntityData extends \Magento\Framework\Model\AbstractExtensibleModel implements EntityDataInterface
{
     ...
     * @var string
     */
    protected $_eventPrefix = 'armah_orderattr_entitydata';
    ...
    {
        $this->_init(\Armah\Orderattr\Model\ResourceModel\Entity\Entity::class);
    }
    ...
    public function reindex()
    {
        ...
        $indexer = $this->indexerRegistry->get(\Armah\Orderattr\Model\ResourceModel\Entity\Entity::GRID_INDEXER_ID);

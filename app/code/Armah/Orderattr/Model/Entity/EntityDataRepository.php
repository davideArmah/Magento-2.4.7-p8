...
use Armah\Orderattr\Api\Data\EntityDataSearchResultsInterfaceFactory;
use Armah\Orderattr\Api\EntityDataRepositoryInterface;
use Armah\Orderattr\Model\Entity\Handler\Save as SaveHandler;
use Armah\Orderattr\Model\ResourceModel\Entity\Entity as EntityResource;
use Armah\Orderattr\Model\ResourceModel\Entity\EntityData\CollectionFactory;
use Armah\Orderattr\Model\ResourceModel\Entity\EntityData\Collection;
...
class EntityDataRepository implements EntityDataRepositoryInterface
{
    ...
    /**
     * @var EntityDataSearchResultsInterfaceFactory
     */
    private $entityDataSearchResultsFactory;
    ...
    public function __construct(
        ...
        ?EntityDataSearchResultsInterfaceFactory $entityDataSearchResultsFactory = null // TODO move to not optional
    ) {
        ...
        $this->entityDataSearchResultsFactory = $entityDataSearchResultsFactory
            ?? ObjectManager::getInstance()->get(EntityDataSearchResultsInterfaceFactory::class);
    }
    ...
    public function getById($entityId)
    {
        if (!isset($this->entityDatas[$entityId])) {
            /** @var \Armah\Orderattr\Model\Entity\EntityData $entityData */
    ...
    public function getList(
        ...
        if ($parentEntityType === null) {
            $parentEntityType = CheckoutEntityInterface::ENTITY_TYPE_ORDER;
        }
        $searchResults = $this->entityDataSearchResultsFactory->create();
        $searchResults->setSearchCriteria($searchCriteria);

        /** @var \Armah\Orderattr\Model\ResourceModel\Entity\EntityData\Collection $entityDataCollection */
        ...
        $entityDataCollection
            ->getSelect()
            ->where(CheckoutEntityInterface::PARENT_ENTITY_TYPE . ' = ?', $parentEntityType);

...
use Armah\Orderattr\Model\Attribute\Repository;
use Armah\Orderattr\Model\ResourceModel\Attribute\TableWorker;
...
{
    public const MAIN_TABLE = 'armah_order_attribute_product_index';
    public const REPLICA_TABLE = 'armah_order_attribute_product_index_replica';

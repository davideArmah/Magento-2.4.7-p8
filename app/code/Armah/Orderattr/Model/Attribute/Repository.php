...
class Repository implements CheckoutAttributeRepositoryInterface
{
    ...
    /**
     * @var \Armah\Orderattr\Api\Data\CheckoutAttributeInterfaceFactory
     */
    ...
    public function __construct(
        \Armah\Orderattr\Model\ResourceModel\Attribute\Attribute $attributeResource,
        ...
        \Armah\Orderattr\Api\Data\CheckoutAttributeInterfaceFactory $attributeFactory
    ) {
    ...
    {
        $validatorAttrCode = new Regex(['pattern' => '/^[a-z][a-z_0-9]{0,60}$/']);

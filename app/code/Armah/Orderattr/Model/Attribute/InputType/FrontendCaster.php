...
use Armah\Orderattr\Model\Attribute\InputType\FrontendCaster\SpecificationProcessorInterface;
use Armah\Orderattr\Model\ResourceModel\Attribute\Relation\RelationDetails\CollectionFactory;
use Armah\Orderattr\Model\Value\LastCheckoutValue;
...
class FrontendCaster
{
     ...
     * @param \Armah\Orderattr\Model\Attribute\InputType\InputType $inputType
    ...
    /**
     * @param array                                                 &$element
     * @param \Armah\Orderattr\Api\Data\CheckoutAttributeInterface $attribute
     * @param \Armah\Orderattr\Model\Attribute\InputType\InputType &$inputType
     *
     * @return void
     */

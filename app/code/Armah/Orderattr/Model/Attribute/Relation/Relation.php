...
class Relation extends \Magento\Framework\Model\AbstractModel implements RelationInterface
{
     ...
     * @param \Armah\Orderattr\Model\ResourceModel\Attribute\Relation\Relation $resource
     * @param \Armah\Orderattr\Model\ResourceModel\Attribute\Relation\Relation\Collection $resourceCollection
    ...
    public function __construct(
        ...
        \Armah\Orderattr\Model\ResourceModel\Attribute\Relation\Relation $resource,
        \Armah\Orderattr\Model\ResourceModel\Attribute\Relation\Relation\Collection $resourceCollection,
        \Armah\Orderattr\Model\Attribute\Relation\RelationDetailsFactory $detailsFactory,
        array $data = []
    ) {
    ...
    {
        $this->_init(\Armah\Orderattr\Model\ResourceModel\Attribute\Relation\Relation::class);
    }
    ...
    protected function getDetailColumnValues($column)
    {
        $options = [];
        foreach ($this->getDetails() as $relationDetail) {
            $option = $relationDetail->getData($column);

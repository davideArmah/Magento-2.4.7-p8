...
use Armah\Orderattr\Model\ResourceModel\Attribute\Relation\RelationDetails\Collection;
...
class RelationValidator
{
    ...
    public function validateRelations(array $data): array
    {
        ...
        $attributesToSave = [];
        /** @var \Armah\Orderattr\Model\Attribute\Relation\RelationDetails $relation */

...
namespace Armah\Orderattr\Model\Attribute;
...
use Armah\Orderattr\Model\Indexer\Conditions\AttributeProcessor;
 ...
 *
 * @method \Armah\Orderattr\Model\ResourceModel\Attribute\Attribute getResource()
...
class Attribute extends \Magento\Eav\Model\Attribute implements CheckoutAttributeInterface
{
     ...
     * Name of the module
     */
    public const MODULE_NAME = 'Armah_Orderattr';
     ...
     * @var string
     */
    protected $_eventPrefix = 'armah_orderattr_entity_attribute';
    ...
    {
        $this->_init(\Armah\Orderattr\Model\ResourceModel\Attribute\Attribute::class);
    ...
    /**
     * @return \Armah\Orderattr\Model\Attribute\InputType\InputType
     */
    ...
    {
        $conditionsSerialized = $this->getData(CheckoutAttributeInterface::CONDITIONS_SERIALIZED);
        if (is_array($conditionsSerialized)) {
            $conditionsSerialized = $this->serializer->serialize($conditionsSerialized);
        }

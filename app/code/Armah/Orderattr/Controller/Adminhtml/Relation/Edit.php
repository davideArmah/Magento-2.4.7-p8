...
use Armah\Orderattr\Model\Attribute\Relation\RelationFactory;
use Magento\Framework\App\Request\DataPersistorInterface;
use Magento\Framework\Controller\ResultFactory;
use Magento\Framework\Registry;

class Edit extends \Armah\Orderattr\Controller\Adminhtml\Relation
{
    /**
    ...
    public function execute()
    {
        ...
        if ($relationId) {
            ...
            /** @var \Armah\Orderattr\Model\Attribute\Relation\Relation $model */
            $model = $this->relationFactory->create();
        }

        if ($savedData = $savedData = $this->dataPersistor->get('armah_order_attribute_relation')) {

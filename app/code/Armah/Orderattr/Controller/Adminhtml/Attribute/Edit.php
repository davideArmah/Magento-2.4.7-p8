...
class Edit extends \Armah\Orderattr\Controller\Adminhtml\Attribute
{
    /**
    ...
    /**
     * @var \Armah\Orderattr\Model\Attribute\CheckoutAttributeRepository
     */
    ...
    public function __construct(
        ...
        \Armah\Orderattr\Api\CheckoutAttributeRepositoryInterface $attributeRepository,
    ...
    public function execute()
    {
        ...
        $resultPage->addBreadcrumb(__('Order'), __('Order'))
            ...
            ->setActiveMenu('Armah_Orderattr::attributes_list')

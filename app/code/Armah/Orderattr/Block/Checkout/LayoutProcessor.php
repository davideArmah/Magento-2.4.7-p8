...
namespace Armah\Orderattr\Block\Checkout;
...
class LayoutProcessor implements LayoutProcessorInterface
{
    ...
    public function process($jsLayout)
    {
        ...
        $this->jsLayout['components']['armahCheckoutProvider'] = ['component' => 'uiComponent'];
    ...
    protected function addAttributesToSidebar()
    {
        ...
        $this->setJsLayoutValue(
            ...
            ['order-attributes-information' =>
                [
                    'component' => 'Armah_Orderattr/js/view/order-attributes-information',

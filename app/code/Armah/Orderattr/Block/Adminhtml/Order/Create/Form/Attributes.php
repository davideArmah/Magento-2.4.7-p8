...
namespace Armah\Orderattr\Block\Adminhtml\Order\Create\Form;
...
/**
 * This form used in Order Create / Order Edit / Order Reorder / Armah Order Attribute Value Edit
 */
class Attributes extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    /**
     * @var \Armah\Orderattr\Model\ResourceModel\Attribute\Collection
     */
    ...
    protected function _prepareForm()
    {
        ...
        $form->addFieldNameSuffix('order[extension_attributes][armah_order_attributes]');
        $this->setForm($form);
    ...
    protected function _initFormValues()
    {
        ...
        if ($this->getQuote() && $this->getQuote()->getExtensionAttributes()) {
            $attributes = $this->getQuote()->getExtensionAttributes()->getArmahOrderAttributes();
            if (!empty($attributes)) {

...
namespace Armah\Orderattr\Block\Adminhtml\Attribute\Edit\Tab\Options;
...
class Options extends \Magento\Eav\Block\Adminhtml\Attribute\Edit\Options\Options
{
    ...
    /**
     * @var \Armah\Orderattr\Model\Attribute\InputType\InputTypeProvider
     */
    ...
    {
        parent::_construct();
        $this->setTemplate('Armah_Orderattr::attribute/options.phtml');
    }

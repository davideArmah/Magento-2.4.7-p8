...
class Main extends AbstractMain
{
    ...
    /**
     * @var \Armah\Orderattr\Model\Config\Source\CustomerGroup
     */
    private $customerGroupSource;

    /**
     * @var \Armah\Orderattr\Model\Config\Source\CheckoutStep
     */
    ...
    /**
     * @var \Armah\Orderattr\Model\Config\Source\Boolean
     */
    private $boolean;
    ...
    public function __construct(
        ...
        \Armah\Orderattr\Model\Attribute\InputType\InputTypeProvider $inputTypeProvider,
        \Armah\Orderattr\Model\Config\Source\CustomerGroup $customerGroupSource,
        \Armah\Orderattr\Model\Config\Source\CheckoutStep $checkoutStepSource,
        \Armah\Orderattr\Model\Config\Source\Boolean $boolean,
        array $data = []
    ) {
        parent::__construct(
            $context,
    ...
    {
        parent::_prepareForm();
        /** @var \Armah\Orderattr\Model\Attribute\Attribute $attributeObject */
        ...
        $booleanValues = $this->boolean->toOptionArray();
        $booleanValues[0]['value'] = null;

        /** Yes/No default values with empty value */
        $fieldset->getElements()
            ->searchById('default_value_yesno')
            ->setValues($booleanValues);

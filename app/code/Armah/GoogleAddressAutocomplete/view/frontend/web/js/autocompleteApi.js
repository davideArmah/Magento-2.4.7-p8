...
define([
    ...
    'Armah_GoogleAddressAutocomplete/js/action/selectPlace'
        ...
        initView: function (fieldsetComponent, input) {
            ...
            if (component) {
                ...
                layout([ {
                    ...
                    'component': 'Armah_GoogleAddressAutocomplete/js/view/suggestionsList',
                    'template': 'Armah_GoogleAddressAutocomplete/suggestion-list',
                    'input': input
                } ], fieldsetComponent);
            }
        }

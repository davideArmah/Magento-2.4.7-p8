...
namespace Armah\Sorting\Plugin\Elasticsearch\Model\Adapter\BatchDataMapper;
...
class AdditionalProductDataMapper
{
    ...
    public function afterMap(
        ...
        if ($this->helper->getOutOfStockLast($storeId)) {
            /** load sku relations needed in @see \Armah\Sorting\Model\Elasticsearch\Adapter\DataMapper\Stock */

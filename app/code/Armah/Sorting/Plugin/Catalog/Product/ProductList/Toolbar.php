...
namespace Armah\Sorting\Plugin\Catalog\Product\ProductList;

use Armah\Sorting\Helper\Data;
use Armah\Sorting\Model\Catalog\Toolbar\GetDefaultDirection;
use Armah\Sorting\Model\Method\ApplyGlobalSorting;
use Armah\Sorting\Model\Method\IsAvailableForSorting;
use Armah\Sorting\Model\ResourceModel\Method\Image as ImageMethod;
use Armah\Sorting\Model\ResourceModel\Method\Instock as InstockMethod;
...
class Toolbar
{
    ...
    {
        if ($collection instanceof ProductCollection && !$this->isFulltextCollection($collection)) {
    ...
    private function isFulltextCollection(ProductCollection $collection): bool
    {
        return $collection instanceof \Magento\CatalogSearch\Model\ResourceModel\Fulltext\Collection
            || $collection instanceof \Armah\Shopby\Model\ResourceModel\Fulltext\Collection
            || $collection instanceof \Armah\ShopbyLite\Model\ResourceModel\Fulltext\Collection;
    }
}

...
namespace Armah\Sorting\Plugin\Catalog\Product;
...
use Armah\Sorting\Model\ResourceModel\Method\Image as ImageMethodResource;
use Armah\Sorting\Model\ResourceModel\Method\Instock as InstockMethodResource;
use Armah\Sorting\Model\SortingAdapterFactory;
use Magento\Framework\DB\Select;
use Magento\Framework\Search\Adapter\Mysql\TemporaryStorage;

/**
 * Plugin Collection
 * plugin name: Armah_Sorting::SortingMethodsProcessor
        ...
        if ($subject->getFlag($flagName)) {
            ...
            if ($method) {
                ...
                if (!$this->isElasticSort()
                    ...
                    || $subject instanceof \Armah\ShopbyLite\Model\ResourceModel\Fulltext\Collection
                ) {

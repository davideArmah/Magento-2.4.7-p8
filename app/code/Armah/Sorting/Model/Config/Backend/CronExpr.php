...
{
    public const CRON_STRING_PATH = 'crontab/index/jobs/armahsorting/schedule/cron_expr';
    public const CRON_MODEL_PATH = 'crontab/index/jobs/armahsorting/run/model';

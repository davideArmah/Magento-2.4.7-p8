...
namespace Armah\Sorting\Block\Widget;

use Armah\Sorting\Model\Source\SortOrder;
...
class Featured extends ProductsList
{
    ...
    {
        if (!$this->hasData('armahsorting_sort_order')) {
            $this->setData('armahsorting_sort_order', self::DEFAULT_COLLECTION_ORDER);
        }
        return $this->getData('armahsorting_sort_order');
    }

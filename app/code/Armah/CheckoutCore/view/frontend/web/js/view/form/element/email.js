define([
    ...
    'Armah_CheckoutCore/js/model/payment-validators/login-form-validator',
    'Armah_CheckoutCore/js/action/save-password',
    'Armah_CheckoutCore/js/model/payment/place-order-state',
    ...
    return Component.extend({
        ...
        initialize: function () {
            ...
            this.template = 'Armah_CheckoutCore/form/element/email';
        ...
        _visibleLoginCaptcha: function () {
            if (this.loginCaptcha()) {
                this.loginCaptcha().currentCaptcha.setIsVisible(
                    (this.isPasswordVisible() && !this.isCreateAccountAction() && window.checkoutConfig.armahOscCaptcha.isLoginCaptcha)
                    || (this.isCreateAccountAction() && window.checkoutConfig.armahOscCaptcha.isCreateAccountCaptcha)
                );
            }
        },
        ...
        _visibleReCaptcha: function () {
            ...
            if (this.recaptcha()) {
                $.async({
                    ...
                    $(loginWrapper).toggle(
                        this.isPasswordVisible() && !this.isCreateAccountAction() && window.checkoutConfig.armahOscCaptcha.isLoginReCaptcha
                    );
                }.bind(this));
            }
            if (this.createAccountRecaptcha()) {
                $.async({
                    ...
                    $(loginWrapper).toggle(
                        this.isCreateAccountAction() && window.checkoutConfig.armahOscCaptcha.isCreateAccountReCaptcha
                    );
                }.bind(this));
            }
        },
        ...
        isReCaptchaVisible: function() {
            return (this.isPasswordVisible() && !this.isCreateAccountAction() && window.checkoutConfig.armahOscCaptcha.isLoginReCaptcha)
                || (this.isCreateAccountAction() && window.checkoutConfig.armahOscCaptcha.isCreateAccountReCaptcha);
        },

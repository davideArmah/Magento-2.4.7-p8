define([
    ...
    'Armah_CheckoutCore/js/model/payment-validators/dob-validator',
    'Armah_CheckoutCore/js/view/additional/register',
    'Armah_CheckoutCore/js/view/checkout/datepicker'
], function (Component, $, paymentValidatorRegistry, dobValidator) {
    'use strict';
    return Component.extend({
        defaults: {
            template: 'Armah_CheckoutCore/form/date',
            listens: {
        ...
        onUpdate: function (newValue) {
            this._super();
            if (this.hasChanged()) {
                this.source.trigger('archeckout.additional:save');
            }
        }
    });
});

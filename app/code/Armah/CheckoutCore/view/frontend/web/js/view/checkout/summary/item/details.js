define(
    [
        ...
        'Armah_CheckoutCore/js/action/remove-item',
        'Armah_CheckoutCore/js/action/update-item',
        'mage/translate',
        'ko',
        'Armah_CheckoutCore/js/options/configurable',
        'priceOptions',
        'mage/validation'
    ],
    function ($, Component, quote, confirm, removeItemAction, updateItemAction, $t, ko, configurable, priceOptions) {
        ...
        return Component.extend({
            defaults: {
                template: 'Armah_CheckoutCore/checkout/summary/item/details',
                messages: {
            ...
            getItemConfig: function (item) {
                return this.getPropertyDataFromItem(item, 'archeckout');
            },
            ...
            preSelectOptions: function (itemConfig, item) {
                ...
                container.archeckoutConfigurable({

define([
    ...
    $.widget('armah.checkoutCollapsibleSteps', $.mage.collapsible, {
        _create: function () {
        ...
        initCollapsible: function () {
            $(this.element).parent().collapsible({
                header: '[data-archeckout-js="step-title"]',
                content: $(this.element).parent().find('[data-archeckout-js="step-content"]'),
                active: true,
                openedState: '-collapsible -opened',
                closedState: '-collapsible -closed',
                icons: {
                    header: 'archeckout-icon -plus',
                    activeHeader: 'archeckout-icon -minus'
                },
                animate: 300
            });
        },
    ...
    return $.armah.checkoutCollapsibleSteps;
});

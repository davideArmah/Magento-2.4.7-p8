define(
    [
        ...
        'Armah_CheckoutCore/js/model/payment-validators/shipping-validator',
        'Armah_CheckoutCore/js/model/address-form-state',
        'Armah_CheckoutCore/js/model/statistic',
        'Armah_CheckoutCore/js/model/shipping-registry',
        'Armah_CheckoutCore/js/action/recollect-shipping-rates',
        'Armah_CheckoutCore/js/model/payment/salesrule-observer',
        'Armah_CheckoutCore/js/action/update-items-content'
    ],
    function (
        $,
        _,

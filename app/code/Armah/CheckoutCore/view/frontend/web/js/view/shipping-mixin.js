define(
    [
        ...
        'Armah_CheckoutCore/js/action/get-totals',
        'Armah_CheckoutCore/js/model/shipping-registry',
        'Armah_CheckoutCore/js/model/address-form-state',
        'Armah_CheckoutCore/js/model/events',
        'uiRegistry',
        'rjsResolver',
        'mage/translate'
    ],
    function (
        ...
        return function (Shipping) {
            return Shipping.extend({
                ...
                /**
                 * Compatibility with Armah_ShippingTableRates and Armah_StorePickup
                 * @param {Object} method Shipping method
                ...
                getCommentShippingMethod: function (method) {
                    ...
                    if (method.extension_attributes) {
                        if (method.extension_attributes.arstorepick_comment) {
                            return method.extension_attributes.arstorepick_comment;
                        }

                        if (method.extension_attributes.arstartes_comment) {
                            return method.extension_attributes.arstartes_comment;
                        }
                    }

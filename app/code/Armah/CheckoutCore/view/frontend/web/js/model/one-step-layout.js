...
define([
    ...
    const MAPPING_BLOCK_NAME = {
            ...
            delivery: 'checkout.steps.shipping-step.archeckout-delivery-date',
        ...
        CLASS_NAMES = {
            ...
            modern: {
                main: 'archeckout-main-container',
                column: 'archeckout-column',
                block: 'archeckout-block archeckout-step-container'
            }
        },
        BLOCK_ATTRS = {
            classic: {},
            modern: {
                main: {
                    'data-archeckout-js': 'main-container'
                }
            }
        };
    ...
    return {
        ...
        gdprConsents: window.checkoutConfig.armahOscGdprConsent,
        gdprComponents: {},
        ...
        getCheckoutBlock: function (blockName) {
            ...
            switch (blockName) {
                case 'shipping_address':
                    if (requestComponent()) {
                        requestComponent().template = 'Armah_CheckoutCore/onepage/shipping/address';
                    }
                ...
                case 'shipping_method':
                    if (requestComponent()) {
                        requestComponent().template = 'Armah_CheckoutCore/onepage/shipping/methods';
                    }
        ...
        getColumnAttrs: function (columnIndex) {
            var columnAttrs = {},
                checkoutJsPrefix = 'data-archeckout-js',

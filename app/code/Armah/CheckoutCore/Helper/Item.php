...
namespace Armah\CheckoutCore\Helper;
...
class Item extends AbstractHelper
{
    ...
    public function getItemOptionsConfig(Quote $quote, $item, $layout)
    {
        ...
        $optionsBlock = $layout->getBlock('archeckout.options.prototype');
    ...
    private function getConfigurableAttributesConfig(QuoteItem $quoteItem, $product, $layout)
    {
        ...
        $configurableAttributesBlock = $layout->getBlock('archeckout.super.prototype');
    ...
    private function getDownloadableCustomOptionsConfig(QuoteItem $quoteItem, $layout)
    {
        ...
        $downloadableBlock = $layout->getBlock('archeckout.downloadable.prototype');
    ...
    private function getBundleCustomOptionsConfig(QuoteItem $quoteItem, $layout)
    {
        ...
        $bundleBlock = $layout->getBlock('archeckout.bundle.prototype');
    ...
    {
        if (!$giftCardBlock = $layout->getBlock('archeckout.giftcard.prototype')) {
            $giftCardBlock = $layout->createBlock(
                \Magento\GiftCard\Block\Catalog\Product\View\Type\Giftcard::class,
                'archeckout.giftcard.prototype'
            );
        }

        $giftCardBlock->setTemplate('Armah_CheckoutCore::product/view/type/options/giftcard.phtml');

...
namespace Armah\CheckoutCore\Plugin\RequireJs\Model;
...
class FileManagerPlugin
{
    ...
    public function __construct(
        ...
        \Armah\CheckoutCore\Model\Optimization\BundleService $bundleService,
    ...
    public function aroundCreateBundleJsPool(\Magento\RequireJs\Model\FileManager $subject, callable $proceed)
    {
        ...
        $bundleFile = \Armah\CheckoutCore\Model\Optimization\Bundle::ROOT_BUNDLE_JS_DIR . '/'
            . $context->getPath() . '/'
            . \Armah\CheckoutCore\Model\Optimization\Bundle::BUNDLE_JS_DIR . '/'
            . \Armah\CheckoutCore\Model\Optimization\Bundle::BUNDLE_SUB_DIR . '/'
            . \Armah\CheckoutCore\Model\Optimization\Bundle::BUNDLE_JS_FILE;

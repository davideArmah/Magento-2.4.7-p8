...
class LayoutProcessor
{
    ...
    public function afterProcess(
        ...
        if ($this->checkoutConfig->isEnabled()) {
            ...
            $layoutRoot['customer-email']['component'] = 'Armah_CheckoutCore/js/view/form/element/email';
            $layoutRoot['customer-email']['template'] = 'Armah_CheckoutCore/form/element/email-no-registration';

...
class Collection extends AbstractCollection
{
    ...
    {
        $this->_init(
            \Armah\CheckoutCore\Model\Field::class,
            \Armah\CheckoutCore\Model\ResourceModel\Field::class
        );
    }
     ...
     * @return Collection
     */
    public function getAttributeCollectionByStoreId($storeId = \Armah\CheckoutCore\Model\Field::DEFAULT_STORE_ID)
    {
        if ($storeId != \Armah\CheckoutCore\Model\Field::DEFAULT_STORE_ID) {

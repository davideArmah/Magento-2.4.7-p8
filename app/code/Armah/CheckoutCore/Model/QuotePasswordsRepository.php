...
use Armah\CheckoutCore\Api\QuotePasswordsRepositoryInterface;
use Armah\CheckoutCore\Model\QuotePasswordsFactory;
use Armah\CheckoutCore\Model\ResourceModel\QuotePasswords as QuotePasswordsResource;
use Armah\CheckoutCore\Model\ResourceModel\QuotePasswords\CollectionFactory;
use Armah\CheckoutCore\Model\ResourceModel\QuotePasswords\Collection;
...
class QuotePasswordsRepository implements QuotePasswordsRepositoryInterface
{
    ...
    public function getById($entityId)
    {
        if (!isset($this->quotePasswordss[$entityId])) {
            /** @var \Armah\CheckoutCore\Model\QuotePasswords $quotePasswords */
    ...
    public function getList(SearchCriteriaInterface $searchCriteria)
    {
        ...
        /** @var \Armah\CheckoutCore\Model\ResourceModel\QuotePasswords\Collection $quotePasswordsCollection */

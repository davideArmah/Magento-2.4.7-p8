...
use Armah\CheckoutCore\Model\ResourceModel\AttributeFormCodes;
...
class SelectFormCodes
{
    ...
    public function execute(Attribute $attribute, array $fieldData): array
    {
        $formCodes = [
            ...
            AttributeFormCodes::ARMAH_CUSTOM_ATTRIBUTES
        ];
        ...
        if ($attribute->getData('on_registration')) {
            ...
            $formCodes[] = AttributeFormCodes::ARMAH_CUSTOM_ATTRIBUTES_REGISTRATION;
        }

        if ($fieldData['enabled']) {
            $formCodes[] = AttributeFormCodes::ADMINHTML_CHECKOUT;
            $formCodes[] = AttributeFormCodes::ARMAH_CUSTOM_ATTRIBUTES_CHECKOUT;
        }

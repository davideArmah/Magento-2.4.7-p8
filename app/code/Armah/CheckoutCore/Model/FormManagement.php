...
use Armah\CheckoutCore\Block\Adminhtml\Field\Edit\Group;
use Armah\CheckoutCore\Block\Adminhtml\Field\Edit\GroupFactory;
use Armah\CheckoutCore\Model\FieldFactory;
use Armah\CheckoutCore\Model\Field\Form\SortFields;
use Armah\CustomerAttributes\Helper\Collection as CustomerAttributesHelper;
use Armah\Orderattr\Model\Attribute\Attribute as OrderAttribute;
use Armah\Orderattr\Model\ResourceModel\Attribute\Collection as OrderattrCollection;
use Armah\Orderattr\Model\ResourceModel\Attribute\CollectionFactory as OrderattrCollectionFactory;
...
class FormManagement
{
    ...
    public const BEFORE_SHIPPING_STEP = 7;
    public const AFTER_SHIPPING_METHODS = 8;
        ...
        switch ($tabId) {
            case ManageCheckoutTabsInterface::CUSTOMER_INFO_TAB:
                ...
                $fields = array_merge(
                    ...
                    $this->getOrderAttributeFields($storeId, [self::SHIPPING_STEP, self::BEFORE_SHIPPING_STEP]),
            ...
            case ManageCheckoutTabsInterface::SHIPPING_METHOD_TAB:
                ...
                $fields = $this->getOrderAttributeFields(
                    $storeId,
                    [self::SHIPPING_METHODS, self::AFTER_SHIPPING_METHODS]
                );
                break;

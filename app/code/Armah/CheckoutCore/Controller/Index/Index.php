...
namespace Armah\CheckoutCore\Controller\Index;
...
class Index extends \Magento\Checkout\Controller\Index\Index
{
    ...
    private function prepareResultPage()
    {
        ...
        $resultPage->getLayout()->getUpdate()->addHandle('armah_checkout');

        if ($this->amCheckoutConfig->getHeaderFooter()) {
            $resultPage->getLayout()->getUpdate()->addHandle('armah_checkout_headerfooter');
        }

        if ($this->amCheckoutConfig->isCheckoutItemsEditable()) {
            $resultPage->getLayout()->getUpdate()->addHandle('armah_checkout_prototypes');
        }

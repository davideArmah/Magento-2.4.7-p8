...
namespace Armah\CheckoutCore\Test\Unit\Model\CustomerAttribute;

use Armah\CheckoutCore\Model\CustomerAttribute\UpdateSortOrder;
...
class UpdateSortOrderTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testExecute(
        ...
        $this->attributeMock
            ->expects($this->exactly(2))
            ->method('setData')
            ->willReturnCallback(function ($key, $value) use ($expectedSortingOrder, $expectedSortOrder) {
                if ($key === 'sorting_order') {
                    $this->assertEquals($expectedSortingOrder, $value);

...
namespace Armah\CheckoutCore\Test\Unit\Model\Config;

use Armah\CheckoutCore\Model\Config\SocialLoginProcessor;
...
class SocialLoginProcessorTest extends TestCase
{
    ...
    private const OSC_CONFIG_CHANGED = 'admin_system_config_changed_section_armah_checkout';

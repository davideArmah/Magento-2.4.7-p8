...
use Armah\CheckoutCore\Model\Field\ConfigManagement\CustomerAttributes\UpdateField;
use Armah\CheckoutCore\Model\Field\Form\GetCustomerAttributes;
use Armah\CheckoutCore\Model\Field\Form\Processor\CustomerAttributes;
use Armah\CheckoutCore\Model\Field\Form\SelectFormCodes;
        ...
        $attributeMock
            ...
            ->willReturnCallback(
                function (
                    ...
                    switch ($key) {
                        case UpdateField::FLAG_NO_FIELD_UPDATE:
                            $this->assertTrue($value);
                            break;
                        case 'sorting_order':
                            $this->assertEquals($expectedSortOrder, $value);
                            break;
                        case 'sort_order':
                            $this->assertEquals($expectedSortOrder + CustomerAttributes::SORT_ORDER_OFFSET, $value);
                            break;
                        case 'used_in_product_listing':
                            $this->assertEquals($expectedIsVisibleOnFront, $value);
                            break;
                        case 'used_in_forms':
                            $this->assertEquals($formCodes, $value);
                            break;
                        case 'required_on_front':

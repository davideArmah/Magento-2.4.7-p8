...
namespace Armah\CheckoutCore\Test\Unit\Model\Field\ConfigManagement;

use Armah\CheckoutCore\Model\Field;
use Armah\CheckoutCore\Model\Field\ConfigManagement\UpdateFieldsByWebsiteId;
use Armah\CheckoutCore\Model\Field\DuplicateField;
...
class UpdateFieldsByWebsiteIdTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testExecuteWithMultipleFields(bool $isEnabled, bool $isRequired): void
    {
        ...
        $this->fieldResourceMock
            ...
            ->method('save')
            ->willReturnMap([
                [$fieldAMock, $fieldAMock],
                [$fieldBMock, $fieldBMock]
            ]);
    ...
    public function testExecuteWithMultipleMissingFields(bool $isEnabled, bool $isRequired): void
    {
        ...
        $this->fieldResourceMock
            ...
            ->method('save')
            ->willReturnMap([
                [$duplicatedFieldAMock, $duplicatedFieldAMock],
                [$duplicatedFieldBMock, $duplicatedFieldBMock]
            ]);

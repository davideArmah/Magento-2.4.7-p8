...
namespace Armah\CheckoutCore\Test\Unit\Model\OrderAttribute;
...
class UpdateSortOrderTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testExecute(
        ...
        $this->attributeMock
            ...
            ->method('__call')
            ->willReturnCallback(function ($method, $value) use ($sortOrder, $expectedResult) {
                if ($method === 'getSortingOrder') {
                    return $sortOrder;
                }

                if ($method === 'setSortingOrder') {
                    $this->assertSame($expectedResult, current($value));
                }

...
use Armah\CheckoutCore\Model\AccountManagement;
...
class AccountManagementTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $customerValidator = $this->createPartialMock(\Armah\CheckoutCore\Model\CustomerValidator::class, ['validateByDataObject']);
    ...
    public function testSavePassword()
    {
        ...
        /** @var \Armah\CheckoutCore\Model\QuotePasswords|MockObject $modelQuotePasswords */
        $modelQuotePasswords = $this->createPartialMock(\Armah\CheckoutCore\Model\QuotePasswords::class, []);

        /** @var \Armah\CheckoutCore\Model\QuotePasswordsRepository|MockObject $repositoryQuotePasswords */
        $repositoryQuotePasswords = $this->createPartialMock(
            \Armah\CheckoutCore\Model\QuotePasswordsRepository::class,
            ['getByQuoteId', 'save']
        );
    ...
    {
        $config = $this->createMock(\Armah\CheckoutCore\Model\Config::class);
    ...
    private function getCustomerExtractor()
    {
        ...
        /** @var \Armah\CheckoutCore\Model\AdditionalFieldsManagement|MockObject $fieldsManagement */
        $customerExtractor = $this->createPartialMock(\Armah\CheckoutCore\Model\Sales\OrderCustomerExtractor::class, ['extract']);
    ...
    /**
     * @return \Armah\CheckoutCore\Model\AdditionalFieldsManagement|MockObject
     * @throws \Exception
     */
    private function getFieldsManagement()
    {
        /** @var \Armah\CheckoutCore\Model\AdditionalFields|MockObject $field */
        $field = $this->createPartialMock(\Armah\CheckoutCore\Model\AdditionalFields::class, []);
        $field->setDateOfBirth(new \DateTime());

        /** @var \Armah\CheckoutCore\Model\AdditionalFieldsManagement|MockObject $fieldsManagement */
        $fieldsManagement = $this->createPartialMock(\Armah\CheckoutCore\Model\AdditionalFieldsManagement::class, ['getByQuoteId']);
    ...
    /**
     * @return \Armah\CheckoutCore\Model\QuotePasswordsRepository|MockObject
     */
    private function getQuotePasswordsRepository()
    {
        $model = $this->createMock(\Armah\CheckoutCore\Model\QuotePasswords::class);
        ...
        /** @var \Armah\CheckoutCore\Model\QuotePasswordsRepository|MockObject $repository */
        $repository = $this->createPartialMock(\Armah\CheckoutCore\Model\QuotePasswordsRepository::class, ['getByQuoteId', 'delete']);

...
use Armah\CheckoutCore\Model\AdditionalFieldsManagement;
...
class AdditionalFieldsManagementTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \Armah\CheckoutCore\Model\AdditionalFields|MockObject
     */
    private $additionalFields;

    /**
     * @var \Armah\CheckoutCore\Model\ResourceModel\AdditionalFields|MockObject
     */
    private $additionalFieldsResource;

    /**
     * @var \Armah\CheckoutCore\Model\AdditionalFieldsFactory|MockObject
     */
    ...
    public function setUp(): void
    {
        ...
        $this->fieldsFactory = $this->createMock(
            \Armah\CheckoutCore\Model\AdditionalFieldsFactory::class
        );

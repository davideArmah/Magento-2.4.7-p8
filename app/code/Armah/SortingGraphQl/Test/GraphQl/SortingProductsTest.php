...
namespace Armah\SortingGraphQl\Test\GraphQl;
...
class SortingProductsTest extends GraphQlAbstract
{
    ...
    private const MAIN_SEARCH_WORD = 'Armah';
     ...
     * @group armah_sorting
     *
     * @magentoApiDataFixture Armah_SortingGraphQl::Test/GraphQl/_files/am_sort_products.php
     * @magentoApiDataFixture Armah_SortingGraphQl::Test/GraphQl/_files/am_sort_wishlist.php
     * @magentoApiDataFixture Armah_SortingGraphQl::Test/GraphQl/_files/am_sort_wishlist_second.php
     */
     ...
     * @group armah_sorting
     *
     * @magentoApiDataFixture Armah_SortingGraphQl::Test/GraphQl/_files/am_sort_customer_order.php
     */

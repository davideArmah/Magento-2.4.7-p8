...
class PlaceholdersProcessor implements LayoutProcessorInterface
{
    ...
    public const ATTRIBUTE_PATHS = [
        '{PAYMENT}.>>.beforeMethods.>>.order-attributes-fields-0.>>',
        '{PAYMENT}.>>.payments-list.>>.before-place-order.>>.order-attributes-fields-0.>>',
        '{SHIPPING_ADDRESS}.>>.before-shipping-method-form.>>.order-attributes-fields-default.>>',
        '{SHIPPING_ADDRESS}.>>.shippingAdditional.>>.order-attributes-fields-default.>>',
        '{SIDEBAR}.>>.summary.>>.totals.>>.order-attributes-fields-0.>>'
    ];

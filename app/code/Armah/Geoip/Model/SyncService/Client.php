...
namespace Armah\Geoip\Model\SyncService;

use Armah\Base\Model\LicenceService\Request\Data\InstanceInfo\Domain as RequestDomain;
use Armah\Base\Model\SysInfo\Provider\Collector\LicenceService\Domain;
...
use Armah\Geoip\Model\BlockFactory;
use Armah\Geoip\Model\BlockV6Factory;
use Armah\Geoip\Model\LocationFactory;
use Armah\Geoip\Model\SyncService\Headers\AddInstanceIdHeader;
...
class Client
{
    public const BLOCK_RESPONSE_KEY = 'armah_geoip_block';
    public const BLOCK_V6_RESPONSE_KEY = 'armah_geoip_block_v6';
    public const LOCATION_RESPONSE_KEY = 'armah_geoip_location';
    private const SYNC_URL = 'https://magento-geoip.saas.armah.it/api/geoip/table_data';

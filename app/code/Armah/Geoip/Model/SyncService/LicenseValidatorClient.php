...
{
    private const VALIDATION_URL = 'https://magento-geoip.saas.armah.it/api/license/validate';
    ...
    public function getMessage(): Phrase
    {
        ...
        if ($this->httpClient->getStatus() >= 400 && $this->httpClient->getStatus() < 500) {
            return __('Invalid license key. To use Armah service, please check the license status.');
        }

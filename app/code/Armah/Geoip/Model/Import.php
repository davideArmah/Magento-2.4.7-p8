...
class Import extends AbstractModel
{
    ...
    public function startProcess($table, $filePath, $action, $ignoredLines = 0)
    {
        ...
        $columns = $write->getTables('armah_geoip_' . $table . '_');
        ...
        $write->truncateTable($this->resource->getTableName('armah_geoip_block'));
        $write->truncateTable($this->resource->getTableName('armah_geoip_block_v6'));
        $write->truncateTable($this->resource->getTableName('armah_geoip_location'));
    ...
    {
        $write = $this->resource->getConnection();
        $blockTable = $this->resource->getTableName('armah_geoip_block');
        $blockV6Table = $this->resource->getTableName('armah_geoip_block_v6');
        $locationTable = $this->resource->getTableName('armah_geoip_location');
    ...
    protected function _prepareImport($table)
    {
        ...
        $targetTable = $this->resource->getTableName('armah_geoip_' . $table);

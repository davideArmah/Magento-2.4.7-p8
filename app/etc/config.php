...
return [
    ...
    'modules' => [
        ...
        'Armah_Geoip' => 1,
        'PayPal_Braintree' => 1,
        'Armah_CheckoutCore' => 1,
        'Armah_CheckoutDeliveryDate' => 1,
        'Armah_CheckoutGiftWrap' => 1,
        'Armah_CheckoutLayoutBuilder' => 1,
        'Armah_CheckoutStyleSwitcher' => 1,
        'Armah_CheckoutThankYouPage' => 1,
        'Armah_CompositeProductPriceIndexer' => 1,
        'Armah_CronScheduleList' => 1,
        'Armah_CrossLinks' => 1,
        'Armah_Checkout' => 1,
        'Armah_GoogleAddressAutocomplete' => 1,
        'Armah_Meta' => 1,
        'Armah_Orderattr' => 1,
        'Hyva_Theme' => 1,
        'Armah_SeoHtmlSitemap' => 1,
        'Armah_SeoToolkitLite' => 1,
        'Armah_SeoRichData' => 1,
        'Hyva_CompatModuleFallback' => 1,
        'Armah_Sorting' => 1,
        'Armah_SortingGraphQl' => 1,
        'Armah_SortingHyvaCompatibility' => 1,
        'Feedaty_Badge' => 1,
        'Hyva_BaseLayoutReset' => 1,
        'Hyva_CmsTailwindJit' => 1,
        'Armah_OrderattrHyva' => 1,
        'Hyva_Email' => 1,

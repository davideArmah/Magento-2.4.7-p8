...
# magento2-mageworx-storelocator
Hyvä Themes Compatibility module for MageWorx_StoreLocator
...
1. Install via composer
    ```
    composer require hyva-themes/magento2-mageworx-storelocator
    ```
2. Enable module
    ```
...
1. Install via composer
    ...
    ```
    composer config repositories.hyva-themes/magento2-mageworx-storelocator git git@gitlab.hyva.io:hyva-themes/hyva-compat/magento2-mageworx-storelocator.git
    composer require hyva-themes/magento2-mageworx-storelocator:dev-main
    ```
2. Enable module
    ```
    bin/magento setup:upgrade
